...
final TextStyle appBarTextStyle = TextStyle(fontFamily: 'Montserrat', fontSize: 20.0, color: Colors.white);
final TextStyle errorStyle = TextStyle(fontFamily: 'Montserrat', fontSize: 13.0);
